classdef MUST5510_AudioTestBenchFINAL_exportedfuckthis < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function [] = streamAudio(app)
            ...
            persistent signal blendAudio aug_signal
            ...
            while ~isDone(app.fileReader) && ...
                ...
                blendAudio = sum(signal,1) + input;
                
                % augment audio
                aug_signal = app.audioAugmenter.step(blendAudio);
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = MUST5510_AudioTestBenchFINAL_exportedfuckthis
